...
from tensorflow.keras.layers import Conv2D, concatenate, BatchNormalization, Lambda, Input, multiply, add, ZeroPadding2D, Activation, Layer
...
# In tf.keras vs keras: activation_49 = conv5_block3_out
#                                *_40 = conv4_block6_out
#                                *_22 = conv3_block4_out
#                                *_10 = conv2_block3_out


def resize_bilinear(x):
    return tf.compat.v1.image.resize_bilinear(x, size=[K.shape(x)[1]*RESIZE_FACTOR, K.shape(x)[2]*RESIZE_FACTOR])
